...
#'
#' A shapefile used in the fisheriescape project, and sourced from: https://gcgeo.gc.ca/geonetwork/metadata/eng/572f6221-4d12-415e-9d5e-984b15d34da4. CRS = ESRI:102001. Accessed with get_shapefile('hex')
#'
...
#' Coastline shapefile
#'
#' A shapefile of the coastline, sourced from: https://www.cec.org/north-american-environmental-atlas/political-boundaries-2021/. Accessed with get_shapefile('coastline')
#'
