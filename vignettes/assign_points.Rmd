...
Using function `table` shows that 69 points fall within the area in which stratum 416 overlaps with Banc-des-Américains Marine Protected Area (e.g., table(df2$polygon)). All other assigned points belong to non-overlapping polygon areas.
```{r fig.height=7}
