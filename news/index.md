...
- Removed function `aggregate_raster` (maybe just temporarily), and
  vignette “Working with rasters”
...
- Increased flexibility of function `convert_dms_to_dd`, to accommodate
...
- Replaced the original hexagonal grid with the one from [Koropatnick
  and Coffen-Smout,
...
- Increased extent of GEBCO bathymetry reference to include NAFO
  divisions 3 through 5.
